...
public class ProfileService {
	...
	String activationLink= baseUrl+"/api/v1.0/activate?token="+newProfile.getActivationToken();
	String subject="Activate your Money Manager account";
	String body="Click on the following link to activate your account: "+activationLink;
	emailService.sendEmail(
		    newProfile.getEmail(),   // ✅ REAL EMAIL
		    subject,
		    body                     // contains the activation link
		);
	...
	public ProfileEntity toEntity(ProfileDTO profileDTO) {
		return ProfileEntity.builder()
				.id(profileDTO.getId())
				.fullNmae(profileDTO.getFullName())
	...
	public ProfileDTO toDTO(ProfileEntity profileEntity) {
		return ProfileDTO.builder()
				...
				.fullName(profileEntity.getFullNmae())
	...
	public ProfileDTO getPublicProfile(String email) {
		...
		return ProfileDTO.builder()
				...
				.fullName(currentUser.getFullNmae())
